...
class Wall(pygame.sprite.Sprite):
    ...
    def draw(self):
        ...
        self.moveVerticesRight(self.velocity)

    def moveVerticesRight(self, velocity):
        ...
        """
        self.v1 = (self.v1[0] + velocity, self.v1[1]) 
        self.v2 = (self.v2[0] + velocity, self.v2[1]) 
        self.v3 = (self.v3[0] + velocity, self.v3[1]) 
        self.v4 = (self.v4[0] + velocity, self.v4[1]) 
